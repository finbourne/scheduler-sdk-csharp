...
# C# SDK for the FINBOURNE Scheduler API
...
This is the C# SDK for the FINBOURNE Scheduler API, part of the [LUSID by FINBOURNE](https://www.finbourne.com/lusid-technology) platform. To use it you'll need a LUSID account - [sign up for free at lusid.com](https://www.lusid.com/app/signup).
...
The NuGet package for the FINBOURNE Scheduler API SDK can installed from https://www.nuget.org/packages/Finbourne.Scheduler.Sdk using the following
