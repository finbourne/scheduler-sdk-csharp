...
using System.IO;
using System.Linq;
using SdkConfiguration = Finbourne.Scheduler.Sdk.Client.Configuration;
...
namespace Finbourne.Scheduler.Sdk.Extensions
{
    ...
    public class ApiConfigurationBuilder
    {
        private static readonly Dictionary<string, string> ConfigNamesToEnvVariables = new Dictionary<string, string>()
            {
                ...
                { nameof(ApiConfiguration.BaseUrl), "FBN_SCHEDULER_URL" },
        ...
        private static readonly Dictionary<string, string> ConfigNamesToSecrets = new Dictionary<string, string>()
        {
            ...
            { nameof(ApiConfiguration.BaseUrl), "schedulerUrl" },
        ...
        private static ApiConfiguration BuildFromEnvironmentVariables(ConfigurationOptions? opts)
        {
            ...
            var apiConfig = new ApiConfiguration
            {
                ...
                BaseUrl = Environment.GetEnvironmentVariable("FBN_SCHEDULER_URL") ??
                          Environment.GetEnvironmentVariable("FBN_FINBOURNE-SCHEDULER_API_URL") ?? 
                          Environment.GetEnvironmentVariable("fbn_finbourne-scheduler_api_url") ?? 
                          Environment.GetEnvironmentVariable("FBN_FINBOURNE_SCHEDULER_API_URL") ?? 
                          Environment.GetEnvironmentVariable("fbn_finbourne_scheduler_api_url"),
