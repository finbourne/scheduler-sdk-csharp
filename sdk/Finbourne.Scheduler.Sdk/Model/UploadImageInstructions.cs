...
namespace Finbourne.Scheduler.Sdk.Model
{
    ...
    public partial class UploadImageInstructions : IEquatable<UploadImageInstructions>, IValidatableObject
    {
        ...
        {
            // DockerLoginCommand (string) minLength
            if (this.DockerLoginCommand != null && this.DockerLoginCommand.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DockerLoginCommand, length must be greater than 1.", new [] { "DockerLoginCommand" });
            }

            // BuildVersionedDockerImageCommand (string) minLength
            if (this.BuildVersionedDockerImageCommand != null && this.BuildVersionedDockerImageCommand.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for BuildVersionedDockerImageCommand, length must be greater than 1.", new [] { "BuildVersionedDockerImageCommand" });
            }

            // TagVersionedDockerImageCommand (string) minLength
            if (this.TagVersionedDockerImageCommand != null && this.TagVersionedDockerImageCommand.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TagVersionedDockerImageCommand, length must be greater than 1.", new [] { "TagVersionedDockerImageCommand" });
            }

            // PushVersionedDockerImageCommand (string) minLength
            if (this.PushVersionedDockerImageCommand != null && this.PushVersionedDockerImageCommand.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PushVersionedDockerImageCommand, length must be greater than 1.", new [] { "PushVersionedDockerImageCommand" });
            }
