...
namespace Finbourne.Scheduler.Sdk.Model
{
    ...
    public partial class ArgumentDefinition : IEquatable<ArgumentDefinition>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // PassedAs (string) minLength
            if (this.PassedAs != null && this.PassedAs.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PassedAs, length must be greater than 1.", new [] { "PassedAs" });
            }
